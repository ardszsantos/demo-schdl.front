...
import { login, type ApiError } from '../api/auth'
    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-zinc-400">Entre com sua conta para continuar</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full rounded-xl border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm text-white placeholder-zinc-600 outline-none ring-0 transition-colors focus:border-primary focus:ring-1 focus:ring-primary/50 disabled:cursor-not-allowed disabled:opacity-50"
              />
            </div>
            ...
            <SubmitButton isPending={isPending} label="Entrar" pendingLabel="Entrando..." />
          </form>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-zinc-500">
          Não tem conta?{' '}
          <Link to="/register" className="font-medium text-primary transition-opacity hover:opacity-80">
            Criar conta
          </Link>
        </p>
